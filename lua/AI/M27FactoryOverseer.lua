                ...
                while sBPIDToBuild == nil do
                    ...
                    if bPlateauFactory and bIsLandFactory then
                        ...
                        if bIsLandFactory then
                            ...
                            if iStrategy == M27Overseer.refStrategyLandMain or iStrategy == M27Overseer.refStrategyEcoAndTech or iStrategy == M27Overseer.refStrategyAirDominance or iStrategy == M27Overseer.refStrategyTurtle then
                                ...
                                elseif iCurrentConditionToTry == 3 then --High priority engineers
                                    ...
                                    elseif iFactoryTechLevel >= 3 and aiBrain:GetEconomyStored('MASS') > 0 and (aiBrain[M27EngineerOverseer.refiBOInitialEngineersWanted] > 0 or (aiBrain[M27EngineerOverseer.refiBOPreReclaimEngineersWanted] > 0 and not(M27Conditions.HaveLowMass(aiBrain)))) and iT3LandFactories >= 3 then
                                        ...
                                        if aiBrain:GetEconomyStoredRatio('MASS') >= 0.4 or (aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200 and aiBrain:GetEconomyStoredRatio('MASS') >= 0.1) then
                                ...
                                elseif iCurrentConditionToTry == 8 then --Emergency defence - enemies are within 27% of our base and we dont think we can beat them
                                    if bDebugMessages == true then LOG(sFunctionRef..': Considering if need emergency defence. aiBrain[M27Overseer.refiPercentageOutstandingThreat]='..aiBrain[M27Overseer.refiPercentageOutstandingThreat]..'; aiBrain[M27Overseer.refiMaxDefenceCoverageWanted]='..aiBrain[M27Overseer.refiMaxDefenceCoverageWanted]..'; aiBrain[M27Overseer.refiModDistFromStartNearestThreat]='..aiBrain[M27Overseer.refiModDistFromStartNearestThreat]) end
                                    if (aiBrain[M27Overseer.refiPercentageOutstandingThreat] < math.min(aiBrain[M27Overseer.refiMaxDefenceCoverageWanted], 0.275) and M27MapInfo.GetSegmentGroupOfLocation(M27UnitInfo.refPathingTypeLand, aiBrain[M27Overseer.reftLocationFromStartNearestThreat]) == M27MapInfo.GetSegmentGroupOfLocation(M27UnitInfo.refPathingTypeLand, M27MapInfo.PlayerStartPoints[aiBrain.M27StartPositionNumber])) or (aiBrain:GetCurrentUnits(refCategoryDFTank) <= aiBrain[refiMinimumTanksWanted] and aiBrain[M27MapInfo.refbCanPathToEnemyBaseWithLand] and not(aiBrain[M27Overseer.refiAIBrainCurrentStrategy] == M27Overseer.refStrategyEcoAndTech) and not(aiBrain[M27Overseer.refbNeedIndirect])) then
                                ...
                                elseif iFactoryTechLevel > 1 or aiBrain[M27Overseer.refiOurHighestLandFactoryTech] < 3 then
                                    if iCurrentConditionToTry == 12 then --Initial engis
                                        if aiBrain[M27EngineerOverseer.refiBOInitialEngineersWanted] > 0 and (not(iStrategy == M27Overseer.refStrategyLandMain) or aiBrain[M27Overseer.refiModDistFromStartNearestThreat] >= 200 or aiBrain:GetCurrentUnits(refCategoryEngineer * M27UnitInfo.ConvertTechLevelToCategory(aiBrain[M27Overseer.refiOurHighestLandFactoryTech]))) <= 8 then
                                            iCategoryToBuild = refCategoryEngineer
                                            iTotalWanted = 1
                                        end
                                    ...
                                    elseif iCurrentConditionToTry == 14 then --Further initialEngiBO, and also Engis if small number of land factories (land attack mode) so engis can get more factories
                                        if aiBrain[M27EngineerOverseer.refiBOInitialEngineersWanted] > 0 or (iStrategy == M27Overseer.refStrategyLandMain and aiBrain:GetListOfUnits(refCategoryLandFactory, false, true) < math.min(4, aiBrain[M27Overseer.reftiMaxFactoryByType][M27Overseer.refFactoryTypeLand]) and aiBrain[M27MapInfo.refbCanPathToEnemyBaseWithLand] and (aiBrain:GetEconomyStored('MASS') > 0 or aiBrain[M27EconomyOverseer.refiMassNetBaseIncome] > -0.3)) then
                                    ...
                                    elseif aiBrain[M27EngineerOverseer.refbNeedResourcesForMissile] == false or M27Conditions.HaveLowMass(aiBrain) == false then
                                        if iCurrentConditionToTry == 16 then --If enemy has firebase near us, then try and build a minimum level of mobile indirect for our current tech level
                                            if iFactoryTechLevel >= 2 then
                                        ...
                                        elseif iCurrentConditionToTry == 16 then --Escort units
                                        ...
                                        elseif iCurrentConditionToTry == 21 then --High priority mobile shields for ACU, and increased limit if have units wanting priority shield still
                                        ...
                                        elseif aiBrain:GetEconomyStored('MASS') > 10 then
                                            if iCurrentConditionToTry == 24 then
                                                ...
                                                if not(aiBrain[M27Overseer.refbNeedIndirect]) and iFactoryTechLevel > 1 and aiBrain[M27MapInfo.refbCanPathToEnemyBaseWithLand] and (iStrategy == M27Overseer.refStrategyLandMain or not(M27Conditions.HaveLowMass(aiBrain))) then
                                                    ...
                                                    if bHaveRightTechLevel then
                                                        ...
                                                        if aiBrain[M27Overseer.refiSkirmisherMassKills] >= math.max(400, aiBrain[M27Overseer.refiSkirmisherMassDeathsAll] * 1.5) then
                                            ...
                                            elseif iCurrentConditionToTry == 25 then--Mobile shields
                                            ...
                                            elseif iCurrentConditionToTry == 26 then --mobile stealth (lower priority)
                                                ...
                                                if bDebugMessages == true then
                                                    if oNearestPlatoonWantingStealth then
                                                        LOG(sFunctionRef..': iFactoryTechLevel='..iFactoryTechLevel..'; aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]='..aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]..'; oNearestPlatoonWantingStealth='..oNearestPlatoonWantingStealth:GetPlan()..oNearestPlatoonWantingStealth[M27PlatoonUtilities.refiPlatoonCount]..'; mass value='..oNearestPlatoonWantingStealth[M27PlatoonUtilities.refiPlatoonMassValue])
                                                    else
                                            ...
                                            elseif iCurrentConditionToTry == 27 then --Intel line scouts and large platoons if multiple land factories
                                                if aiBrain[M27Overseer.refiScoutShortfallIntelLine] + aiBrain[M27Overseer.refiScoutShortfallPriority] + aiBrain[M27Overseer.refiScoutShortfallLargePlatoons] > 0 then
                                                    if aiBrain[M27Overseer.refiScoutShortfallIntelLine] + aiBrain[M27Overseer.refiScoutShortfallPriority] > 0 then
                                                        iCategoryToBuild = refCategoryLandScout
                                                        iTotalWanted = aiBrain[M27Overseer.refiScoutShortfallIntelLine] + aiBrain[M27Overseer.refiScoutShortfallPriority]
                                            ...
                                            elseif iCurrentConditionToTry == 28 then --Core engis
                                            ...
                                            elseif iCurrentConditionToTry == 29 then --MAA main
                                            ...
                                            elseif iCurrentConditionToTry == 30 then --Scouts for large platoons
                                            ...
                                            elseif iCurrentConditionToTry == 31 then --Pre-spare engis
                                            ...
                                            elseif iCurrentConditionToTry == 32 then --Threat range
                                            ...
                                            elseif M27Conditions.HaveLowMass(aiBrain) == false then
                                                if iCurrentConditionToTry == 33 then --Skirmishers if are effective
                                                ...
                                                elseif iCurrentConditionToTry == 34 then --More MAA
                                                    if aiBrain[M27Overseer.refbNeedMAABuilt] == true then
                                                        iCategoryToBuild = refCategoryMAA
                                                        if iStrategy == M27Overseer.refStrategyLandMain then
                                                ...
                                                elseif iCurrentConditionToTry == 35 then --Engis if lots of mass stored
                                                ...
                                                elseif iCurrentConditionToTry == 37 then --Lots of mass or arent building an experimental
                                                ...
                                                elseif iCurrentConditionToTry == 38 then --Want at least 2 spare engis
                                                    if iStrategy == M27Overseer.refStrategyLandMain or iStrategy == M27Overseer.refStrategyTurtle then
                                                ...
                                                elseif iCurrentConditionToTry == 39 then --Scouts for small platoons
                                                    if iStrategy == M27Overseer.refStrategyLandMain then
                                                ...
                                                elseif iCurrentConditionToTry == 41 then --Spare engis
                                                    ...
                                                    if (aiBrain:GetEconomyStored('MASS') >= 3000 and M27Utilities.IsTableEmpty(aiBrain[M27EngineerOverseer.reftEngineerAssignmentsByActionRef][M27EngineerOverseer.refActionBuildExperimental])) or aiBrain:GetEconomyStoredRatio('MASS') >= 0.9 or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200 or (aiBrain:GetEconomyStoredRatio('MASS') >= 0.5 and aiBrain:GetEconomyStored('MASS') >= 1000 and aiBrain[M27EconomyOverseer.refiMassNetBaseIncome] > 0.1) then
                                                        iCategoryToBuild = refCategoryEngineer
                                                        iTotalWanted = 100
                                                    else
                        ...
                        elseif bIsAirFactory then
                            ...
                            if bDebugMessages == true then LOG('bHavePowerForAir='..tostring(bHavePowerForAir)..'; iFactoryTechLevel='..iFactoryTechLevel..'; iMinPowerPerTickWantedForAir='..iMinPowerPerTickWantedForAir..'; aiBrain[M27EconomyOverseer.refbStallingEnergy]='..tostring(aiBrain[M27EconomyOverseer.refbStallingEnergy])..'; aiBrain[M27Overseer.refiAIBrainCurrentStrategy]='..aiBrain[M27Overseer.refiAIBrainCurrentStrategy]..'; aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]='..aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]..'; aiBrain:GetEconomyStoredRatio(ENERGY)='..aiBrain:GetEconomyStoredRatio('ENERGY')..'; aiBrain[M27EconomyOverseer.refiEnergyGrossBaseIncome]='..aiBrain[M27EconomyOverseer.refiEnergyGrossBaseIncome]..'; AvailableAirAA empty='..tostring(aiBrain[M27AirOverseer.reftAvailableAirAA])..'; Enemy has T2 navy near our base='..tostring(aiBrain[M27Overseer.refbT2NavyNearOurBase])) end
                            ...
                            if (aiBrain[M27Overseer.refiAIBrainCurrentStrategy] == M27Overseer.refStrategyACUKill or aiBrain[M27Overseer.refiAIBrainCurrentStrategy] == M27Overseer.refStrategyProtectACU) and bHavePowerForAir then
                                ...
                                if iCurrentConditionToTry == 1 then
                                    ...
                                    elseif iFactoryTechLevel >= 3 and iT3AirFactories >= 3 and aiBrain:GetEconomyStored('MASS') > 0 and (aiBrain[M27EngineerOverseer.refiBOInitialEngineersWanted] > 0 or (aiBrain[M27EngineerOverseer.refiBOPreReclaimEngineersWanted] > 0 and not(M27Conditions.HaveLowMass(aiBrain))) or aiBrain:GetEconomyStoredRatio('MASS') >= 0.5 or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200) then
                                        ...
                                        if not(aiBrain[M27Overseer.refbT2NavyNearOurBase]) and (aiBrain:GetEconomyStoredRatio('MASS') >= 0.5 or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200) then
                                ...
                                elseif iCurrentConditionToTry == 6 then
                                    ...
                                    elseif iFactoryTechLevel >= 3 then
                                        ...
                                        if (bHavePowerForAir or aiBrain[M27EconomyOverseer.refiEnergyGrossBaseIncome] >= 250) and M27Conditions.LifetimeBuildCountLessThan(aiBrain, M27UnitInfo.refCategoryAirScout * categories.TECH3, 1) == true and not(aiBrain[M27AirOverseer.refbHaveOmniVision]) then
                                            if bDebugMessages == true then
                                ...
                                elseif iCurrentConditionToTry == 9 then --No living air scouts - get more if have certain level of mass
                                    if bHavePowerForAir and (aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 5 or not(M27Conditions.HaveLowMass(aiBrain))) and aiBrain[M27AirOverseer.refiOurMassInAirAA] > 75 then
                                        ...
                                        if not(aiBrain[M27AirOverseer.refbHaveOmniVision]) and (iCurAirScouts == 0 or (iCurAirScouts <= 3 and aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 10 and (iCurAirScouts <= 1 or aiBrain[M27AirOverseer.refiExtraAirScoutsWanted] >= 5 or iCurAirScouts < aiBrain:GetCurrentUnits(categories.EXPERIMENTAL) + 1))) then
                                            iCategoryToBuild = refCategoryAirScout
                                            iTotalWanted = 1
                                        end
                                    end

                                elseif iCurrentConditionToTry == 10 then --Signifcant AirAA shortfall
                                    ...
                                    if bHavePowerForAir and (aiBrain[M27AirOverseer.refiAirAANeeded] >= 2 or (aiBrain[M27AirOverseer.refiAirAAWanted] >= 10 and aiBrain[M27AirOverseer.refiTeamMassInAirAA] / math.max(aiBrain[M27AirOverseer.refiHighestEnemyAirThreat], 1) < 0.7)) then
                                        ...
                                        if aiBrain:GetCurrentUnits(M27UnitInfo.refCategoryAirFactory) >= 2 then
                                            iCategoryToBuild = refCategoryAirAA
                                            if iT3AirFactories >= 3 then iTotalWanted = math.floor(iT3AirFactories * 0.67)
                                            else iTotalWanted = 1
                                            end
                                        end
                                    end
                                ...
                                elseif iCurrentConditionToTry == 13 then --AirAA needed
                                    if bDebugMessages == true then
                        ...
                        elseif bIsNavalFactory then
                            ...
                            if iCurrentConditionToTry == 1 then --Immediate threat to base
                                if M27UnitInfo.IsUnitValid(M27Team.tTeamData[aiBrain.M27Team][M27Team.refoClosestEnemyNavalUnitByPond][oFactory[M27Navy.refiAssignedPond]]) then
                                    ...
                                    if M27Utilities.GetDistanceBetweenPositions(oFactory:GetPosition(), M27Team.tTeamData[aiBrain.M27Team][M27Team.refoClosestEnemyNavalUnitByPond][oFactory[M27Navy.refiAssignedPond]]:GetPosition()) <= 100 then
                                        ...
                                        if EntityCategoryContains(M27UnitInfo.refCategoryNavalSurface - categories.ANTINAVY, M27Team.tTeamData[aiBrain.M27Team][M27Team.refoClosestEnemyNavalUnitByPond][oFactory[M27Navy.refiAssignedPond]].UnitId) then
                            ...
                            elseif iCurrentConditionToTry == 2 then --Antiair if have very little
                                    ...
                                    if iAirThreatWanted >= 150 then
                                        ...
                                        if iFactoryTechLevel == 1 then
                                            if EntityCategoryContains(categories.AEON, oFactory.UnitId) then
                                                iCategoryToBuild = M27UnitInfo.refCategoryNavalAA
                                            else
                                                iCategoryToBuild = M27UnitInfo.refCategoryFrigate
                                            end
                                        else
                            ...
                            elseif iCurrentConditionToTry == 3 then --Upgrade to t2 naval fac
                            ...
                            elseif iCurrentConditionToTry == 4 then --Build a few subs initially if not against aeon (who have torp defense on frigates)
                                if bDebugMessages == true then LOG(sFunctionRef..': Considering whether to get initial game subs. Factory tech='..iFactoryTechLevel..'; is table of enemy units empty='..tostring(M27Utilities.IsTableEmpty(M27Team.tTeamData[aiBrain.M27Team][M27Team.reftEnemyUnitsByPond][oFactory[M27Navy.refiAssignedPond]]))) end
                                if iFactoryTechLevel <= 2 and (M27Utilities.IsTableEmpty(M27Team.tTeamData[aiBrain.M27Team][M27Team.reftEnemyUnitsByPond][oFactory[M27Navy.refiAssignedPond]]) or M27Utilities.IsTableEmpty(EntityCategoryFilterDown(categories.AEON, M27Team.tTeamData[aiBrain.M27Team][M27Team.reftEnemyUnitsByPond][oFactory[M27Navy.refiAssignedPond]]))) then
                            ...
                            elseif iCurrentConditionToTry == 8 then --Cruisers if have none
                                if iFactoryTechLevel >= 2 and M27Utilities.IsTableEmpty(EntityCategoryFilterDown(M27UnitInfo.refCategoryCruiserCarrier, M27Team.tTeamData[aiBrain.M27Team][M27Team.reftFriendlyUnitsByPond][oFactory[M27Navy.refiAssignedPond]])) then
                            ...
                            elseif iCurrentConditionToTry == 10 then --Build whichever we're furthest behind on - antisubmersible, or surface
                                ...
                                if iMaxThreatRatioWanted * iEnemySurfaceThreat < iOurNavalThreat and iMaxThreatRatioWanted * iEnemySubmersibleThreat < iOurAntiNavyThreat then
                                    ...
                                    if iOurNavalThreat == 0 or iMaxThreatRatioWanted * iEnemySubmersibleThreat < iOurAntiNavyThreat then
                                        ...
                                        iCategoryToBuild = iSurfaceCategoryToBuild
                            ...
                            elseif not(M27Conditions.HaveLowMass(aiBrain)) and aiBrain:GetEconomyStoredRatio('ENERGY') >= 0.99 and aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome] > 3 then
                                if iCurrentConditionToTry == 11 then
                                    ...
                                    if iFactoryTechLevel < 3 and (oFactory == M27Navy.GetPrimaryNavalFactory(aiBrain, oFactory[M27Navy.refiAssignedPond]) or aiBrain:GetEconomyStored('MASS') >= 2000 * iFactoryTechLevel or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 10 * iFactoryTechLevel) and
                                            ...
                                            (aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 8 or (aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 7 and M27Conditions.GetLifetimeBuildCount(aiBrain, M27UnitInfo.refCategoryAllNavy * categories.TECH2) >= 8)) then
                                ...
                                elseif iFactoryTechLevel >= 2 then
                                    if iCurrentConditionToTry == 14 then --More bombardment units based on number of mexes in range
                                        ...
                                        if EntityCategoryContains(categories.UEF + categories.SERAPHIM, oFactory.UnitId) then
                                            ...
                                            if iCurCruisers < 5 or bHaveBattleship or iFactoryTechLevel == 2 then
                                        ...
                                        if iExistingBombardmentUnits == 0 or iExistingBombardmentUnits <= math.max(iFactoryTechLevel - 1, aiBrain[M27Navy.reftiPondValueToUs][oFactory[M27Navy.refiAssignedPond]] * 0.3) then
                                            ...
                                            if bDebugMessages == true then LOG(sFunctionRef..': iMexesInRange='..iMexesInRange..'; iUnitsPerMexInRange='..iUnitsPerMexInRange) end
                        ...
                        elseif bIsQuantumGateway then
                            if iCurrentConditionToTry == 1 then
                                ...
                                if bDebugMessages == true then LOG(sFunctionRef..': Energy stored='..aiBrain:GetEconomyStored('ENERGY')..'; ratio='..aiBrain:GetEconomyStoredRatio('ENERGY')..'; Net energy income='..aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]..'; Last energy stall='..(GetGameTimeSeconds() - (aiBrain[M27EconomyOverseer.refiLastEnergyStall] or -100))) end
                                if aiBrain:GetEconomyStored('ENERGY') >= 4000 and aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 7 and (aiBrain:GetEconomyStoredRatio('ENERGY') >= 0.99 or aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome] >= 250) and GetGameTimeSeconds() - (aiBrain[M27EconomyOverseer.refiLastEnergyStall] or -100) >= 10 then
                    ...
                    if iCategoryToBuild == refCategoryEngineer or iCategoryToBuild == refCategoryEngineer * categories.TECH2 or iCategoryToBuild == refCategoryEngineer * categories.TECH3 then
                        ...
                        if bReachedLastOption and (aiBrain:GetEconomyStoredRatio('MASS') >= 0.6 or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200) and aiBrain:GetEconomyStoredRatio('ENERGY') >= 0.99 and aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome] >= 50 then
                            if bIsLandFactory then
                                iCategoryToBuild = GetLandCombatCategory(aiBrain, oFactory, iFactoryTechLevel, false)
                    ...
                    elseif iFactoryTechLevel == 3 and (iCategoryToBuild == refCategoryBomber or iCategoryToBuild == refCategoryBomber * categories.TECH3) and aiBrain:GetCurrentUnits(refCategoryBomber * categories.TECH3) >= 25 then
                        ...
                        if bDebugMessages == true then
                            LOG(sFunctionRef .. ': Have lots of T3 bombers already so will set to nil unless have high mass. aiBrain:GetEconomyStoredRatio=' .. aiBrain:GetEconomyStoredRatio('MASS') .. '; aiBrain[M27EconomyOverseer.refiMassNetBaseIncome]=' .. aiBrain[M27EconomyOverseer.refiMassNetBaseIncome])
                        end
