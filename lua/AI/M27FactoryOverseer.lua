...
function DetermineWhatToBuild(aiBrain, oFactory)
    ...
    --if oFactory.UnitId..M27UnitInfo.GetUnitLifetimeCount(oFactory) == 'ueb01019' and GetGameTimeSeconds() >= 1200 then bDebugMessages = true end
    ...
    if not(oFactory.GetBlueprint) then M27Utilities.ErrorHandler('Factory doesnt have a blueprint')
        ...
        if oFactoryBlueprint then
            ...
            if bIsAirFactory then iT3AirFactories = aiBrain:GetCurrentUnits(M27UnitInfo.refCategoryAirFactory * categories.TECH3) end
            ...
            if iFactoryTechLevel >= 3 or not(aiBrain[M27Overseer.refbCloseToUnitCap]) then
                while sBPIDToBuild == nil do
                    ...
                    if bPlateauFactory and bIsLandFactory then
                        ...
                        if not(bHaveLowPower) and (not(bHaveLowMass) or iStrategy == aiBrain[M27Overseer.refiDefaultStrategy]) then
                            ...
                            elseif iCurrentConditionToTry == 11 then
                                ...
                                elseif iCurDFTanks < math.max(4, 1.5 * iPlateauMexCount) then
                                    ...
                                    iCategoryToBuild = refCategoryDFTank
                                elseif iCurScouts < 4 + math.min(5, math.floor(iPlateauMexCount * 0.3)) then
                        ...
                        if bIsLandFactory then
                            ...
                            if iStrategy == M27Overseer.refStrategyLandMain or iStrategy == M27Overseer.refStrategyEcoAndTech or iStrategy == M27Overseer.refStrategyAirDominance or iStrategy == M27Overseer.refStrategyTurtle then
                                ...
                                elseif iCurrentConditionToTry == 8 then --Emergency defence - enemies are within 27% of our base
                                    if bDebugMessages == true then LOG(sFunctionRef..': Considering if need emergency defence. aiBrain[M27Overseer.refiPercentageOutstandingThreat]='..aiBrain[M27Overseer.refiPercentageOutstandingThreat]..'; aiBrain[M27Overseer.refiMaxDefenceCoverageWanted]='..aiBrain[M27Overseer.refiMaxDefenceCoverageWanted]) end
                                ...
                                elseif iCurrentConditionToTry == 10 then --Emergency amphibious response
                                ...
                                elseif iFactoryTechLevel > 1 or aiBrain[M27Overseer.refiOurHighestLandFactoryTech] < 3 then
                                    if iCurrentConditionToTry == 11 then --Initial engis
                                    ...
                                    elseif iCurrentConditionToTry == 13 then --Further initialEngiBO, and also Engis if small number of land factories (land attack mode) so engis can get more factories
                                    ...
                                    elseif iCurrentConditionToTry == 14 then --Mobile shields if have small number and have priority units near base wanting shielding
                                        if iFactoryTechLevel >= 2 then
                                    ...
                                    elseif aiBrain[M27EngineerOverseer.refbNeedResourcesForMissile] == false or M27Conditions.HaveLowMass(aiBrain) == false then
                                        if iCurrentConditionToTry == 15 then --Escort units
                                        ...
                                        elseif iCurrentConditionToTry == 16 then --MAA initial
                                        ...
                                        elseif iCurrentConditionToTry == 17 then --Emergency defence - enemies are within 32.5% of our base
                                        ...
                                        elseif iCurrentConditionToTry == 18 then --Min of 3 engineers of the current tech level
                                        ...
                                        elseif iCurrentConditionToTry == 19 then --High priority mobile stealth
                                            if iFactoryTechLevel >= 2 then
                                        ...
                                        elseif iCurrentConditionToTry == 20 then --High priority mobile shields for ACU, and increased limit if have units wanting priority shield still
                                        ...
                                        elseif iCurrentConditionToTry == 21 then --T3 mobile artillery if are turtling and havent tried building any and enemy has significant mobile threat
                                        ...
                                        elseif aiBrain:GetEconomyStored('MASS') > 10 then
                                            ...
                                            elseif iCurrentConditionToTry == 23 then--Mobile shields
                                            ...
                                            elseif iCurrentConditionToTry == 24 then --mobile stealth (lower priority)
                                            ...
                                            elseif iCurrentConditionToTry == 25 then --Intel line scouts and large platoons if multiple land factories
                                            ...
                                            elseif iCurrentConditionToTry == 26 then --Core engis
                                            ...
                                            elseif iCurrentConditionToTry == 27 then --MAA main
                                            ...
                                            elseif iCurrentConditionToTry == 28 then --Scouts for large platoons
                                            ...
                                            elseif iCurrentConditionToTry == 29 then --Pre-spare engis
                                            ...
                                            elseif iCurrentConditionToTry == 30 then --Threat range
                                            ...
                                            elseif M27Conditions.HaveLowMass(aiBrain) == false then
                                                if iCurrentConditionToTry == 31 then --Skirmishers if are effective
                                                    if iFactoryTechLevel > 1 and not(aiBrain[M27Overseer.refbNeedIndirect]) and aiBrain[M27MapInfo.refbCanPathToEnemyBaseWithLand] and aiBrain[M27Overseer.refiSkirmisherMassKills] > math.max(400, aiBrain[M27Overseer.refiSkirmisherMassDeathsAll], aiBrain[M27Overseer.refiSkirmisherMassDeathsFromLand] * 1.5, aiBrain[M27Overseer.refiSkirmisherMassBuilt] * 0.25) then
                                                        local iFactionIndex = M27UnitInfo.GetUnitFaction(oFactory)
                                                        local bHaveRightTechLevel = false
                                                        if (iFactionIndex == M27UnitInfo.refFactionUEF or iFactionIndex == M27UnitInfo.refFactionCybran) then
                                                ...
                                                elseif iCurrentConditionToTry == 32 then --More MAA
                                                    if aiBrain[M27Overseer.refbNeedMAABuilt] == true then
                                                        iCategoryToBuild = refCategoryMAA
                                                        if iStrategy == M27Overseer.refStrategyLandMain then
                                                ...
                                                elseif iCurrentConditionToTry == 33 then --Engis if lots of mass stored
                                                ...
                                                elseif iCurrentConditionToTry == 34 then --Arti ratio provided not building experimental or have high mass
                                                    if iStrategy == M27Overseer.refStrategyLandMain then
                                                ...
                                                elseif iCurrentConditionToTry == 35 then --Lots of mass or arent building an experimental
                                                    if aiBrain:GetEconomyStored('MASS') >= 3000 or M27Utilities.IsTableEmpty(aiBrain[M27EngineerOverseer.reftEngineerAssignmentsByActionRef][M27EngineerOverseer.refActionBuildExperimental]) then
                                                ...
                                                elseif iCurrentConditionToTry == 36 then --Want at least 2 spare engis
                                                    if iStrategy == M27Overseer.refStrategyLandMain or iStrategy == M27Overseer.refStrategyTurtle then
                                                ...
                                                elseif iCurrentConditionToTry == 37 then --Scouts for small platoons
                                                    if iStrategy == M27Overseer.refStrategyLandMain then
                    ...
                    break
                        ...
                        elseif bIsAirFactory then
                            ...
                            if bDebugMessages == true then LOG('bHavePowerForAir='..tostring(bHavePowerForAir)..'; iFactoryTechLevel='..iFactoryTechLevel..'; iMinPowerPerTickWantedForAir='..iMinPowerPerTickWantedForAir..'; aiBrain[M27EconomyOverseer.refbStallingEnergy]='..tostring(aiBrain[M27EconomyOverseer.refbStallingEnergy])..'; aiBrain[M27Overseer.refiAIBrainCurrentStrategy]='..aiBrain[M27Overseer.refiAIBrainCurrentStrategy]..'; aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]='..aiBrain[M27EconomyOverseer.refiEnergyNetBaseIncome]..'; aiBrain:GetEconomyStoredRatio(ENERGY)='..aiBrain:GetEconomyStoredRatio('ENERGY')..'; aiBrain[M27EconomyOverseer.refiEnergyGrossBaseIncome]='..aiBrain[M27EconomyOverseer.refiEnergyGrossBaseIncome]..'; AvailableAirAA empty='..tostring(aiBrain[M27AirOverseer.reftAvailableAirAA])) end
                            ...
                            if (aiBrain[M27Overseer.refiAIBrainCurrentStrategy] == M27Overseer.refStrategyACUKill or aiBrain[M27Overseer.refiAIBrainCurrentStrategy] == M27Overseer.refStrategyProtectACU) and bHavePowerForAir then
                                ...
                                elseif iCurrentConditionToTry == 9 then --Signifcant AirAA shortfall
                                ...
                                elseif iCurrentConditionToTry == 21 then
                                    ...
                                    if bHavePowerForAir and aiBrain[M27AirOverseer.refbBombersAreEffective][iFactoryTechLevel] == true and (aiBrain[M27AirOverseer.refbBombersAreReallyEffective][iFactoryTechLevel] or (iFactoryTechLevel == 3 and M27Conditions.GetLifetimeBuildCount(aiBrain, M27UnitInfo.refCategoryBomber * categories.TECH3) <= 2) or (not (M27Conditions.HaveLowMass(aiBrain)) and aiBrain:GetCurrentUnits(refCategoryBomber * M27UnitInfo.ConvertTechLevelToCategory(iFactoryTechLevel)) == 0)) then
                                        --If at T3 and already have 5 available T3 bombers, and have low mass, then dont build
                                        if iFactoryTechLevel < 3 or not(M27Conditions.HaveLowMass(aiBrain)) or M27Utilities.IsTableEmpty(aiBrain[M27AirOverseer.reftAvailableBombers]) or M27Utilities.IsTableEmpty(EntityCategoryFilterDown(categories.TECH3, aiBrain[M27AirOverseer.reftAvailableBombers])) or (table.getn(aiBrain[M27AirOverseer.reftAvailableBombers]) <= 5 or table.getn(EntityCategoryFilterDown(categories.TECH3, aiBrain[M27AirOverseer.reftAvailableBombers])) <= 4) then
                                            if iFactoryTechLevel >= 2 and (M27UnitInfo.GetUnitFaction(oFactory) == M27UnitInfo.refFactionUEF or iFactoryTechLevel == 3) and M27Conditions.GetLifetimeBuildCount(aiBrain, M27UnitInfo.refCategoryBomber * categories.TECH1) <= 5 then
                                                iCategoryToBuild = refCategoryBomber * categories.TECH1
                                    ...
                                    elseif M27Conditions.HaveLowMass(aiBrain) == false then
                                        ...
                                        elseif iCurrentConditionToTry == 30 then
                                            ...
                                            if iStrategy == M27Overseer.refStrategyEcoAndTech and aiBrain:GetEconomyStoredRatio('Mass') <= 0.7 then
                                                ...
                                                if bHavePowerForAir and not(M27Conditions.HaveLowMass(aiBrain)) and ((aiBrain:GetEconomyStoredRatio('MASS') > 0.4 and aiBrain[M27AirOverseer.refbBombersAreEffective][iFactoryTechLevel] == true) or (aiBrain:GetEconomyStoredRatio('MASS') >= 0.7 or aiBrain[M27EconomyOverseer.refiMassGrossBaseIncome] >= 200)) and aiBrain:GetEconomyStored('MASS') > 750 then
                                                    if bDebugMessages == true then
                    ...
                    if sBPIDToBuild then
                        ...
                        if aiBrain[M27Overseer.refbCloseToUnitCap] and iUnitToBuildTechLevel <= 2 then
                            sBPIDToBuild = nil
                        else
                            if bIsLandFactory then
