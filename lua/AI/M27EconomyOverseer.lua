...
function GetCategoriesAndActionsToPause(aiBrain, bStallingMass)
    ...
    if bStallingMass then
        ...
        if aiBrain[M27Overseer.refbT2NavyNearOurBase] then
            ...
            tCategoriesByPriority = { M27UnitInfo.refCategorySMD, M27UnitInfo.refCategoryEngineerStation, M27UnitInfo.refCategoryRASSACU, M27UnitInfo.refCategoryEngineer, M27UnitInfo.refCategoryTML, M27UnitInfo.refCategoryLandFactory, M27UnitInfo.refCategoryAirFactory, iSpecialHQCategory, categories.COMMAND, M27UnitInfo.refCategoryEngineer }
        else
            tCategoriesByPriority = { M27UnitInfo.refCategorySMD, M27UnitInfo.refCategoryEngineerStation, M27UnitInfo.refCategoryLandFactory, M27UnitInfo.refCategoryRASSACU, M27UnitInfo.refCategoryEngineer, M27UnitInfo.refCategoryTML, M27UnitInfo.refCategoryAirFactory, iSpecialHQCategory, categories.COMMAND, M27UnitInfo.refCategoryEngineer }
        end
